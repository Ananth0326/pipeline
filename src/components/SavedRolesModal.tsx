    ...
    return (
        <>
            <button
                ...
                className="subtle-control inline-flex items-center gap-2 rounded-xl px-4 py-2 text-[10px] font-black uppercase tracking-widest"
            >
                        ...
                        >
                            ...
                            <div className="p-6 md:p-8 flex items-center justify-between border-b border-black/10">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setIsOpen(false)}
                                    className="rounded-full p-2 text-[#78716C] hover:bg-black/5 hover:text-[#1C1917] transition-colors"
