                ...
                <div className="lg:col-span-8 space-y-12 md:space-y-16">
                    ...
                    {company.jd_text && (
                        <section className="space-y-6">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-950 p-10 rounded-3xl border dark:border-gray-800 whitespace-pre-wrap text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                                {company.jd_text}
                            </div>
                        </section>
                    )}
